          ...
          <div class="editor-container">
            ...
            <div v-if="checkOptionsCustomizer"
              ...
              <button class="button-options"
                      title="Adjust Options" :style="optionsClick ? 'background: rgba(248, 248, 248, 1);' : '' "
                      @click="optionsClick = !optionsClick">
              ...
              <div v-show="optionsClick" class="options-container" @scroll="optionsScroll">
                  ...
                  <div class="first-row">
                    ...
                    <div v-show="moreOptionsClick" class="more-options">
                      <button class="save-options" @click="optionsEvents">
                        <ChevronSaveIcon :size="16"/>
                        Save
                      </button>
                      <button class="delete-options" @click="optionsEvents">
                        <ChevronDeleteIcon :size="16"/>
                        Reset
                      </button>
                    </div>
                  </div>
                ...
                <div class="divider-buttons">
                  <svg width="100%" height="2" viewBox="0 0 240 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 1H240" stroke="#ECECEC"/>
                  </svg>
                </div>
...
import ChevronCopyIcon from '@apostrophecms/vue-material-design-icons/ClipboardMultiple.vue';
import ChevronUndoIcon from '@apostrophecms/vue-material-design-icons/Undo.vue';
import ChevronDotVerticalIcon from '@apostrophecms/vue-material-design-icons/DotsVertical.vue';
import ChevronGearIcon from '@apostrophecms/vue-material-design-icons/Cog.vue';
import ChevronSaveIcon from '@apostrophecms/vue-material-design-icons/ContentSave.vue';
import ChevronDeleteIcon from '@apostrophecms/vue-material-design-icons/Delete.vue';
import ChevronDropdownIcon from '@apostrophecms/vue-material-design-icons/ChevronDown.vue';
import ChevronDropupIcon from '@apostrophecms/vue-material-design-icons/ChevronUp.vue';
...
const theme = browserOptions.ace.theme;
...
for (let i = 0; i < apos.customCodeEditor.browser.ace._otherFiles.length; i++) {
  const otherFiles = apos.customCodeEditor.browser.ace._otherFiles[i];
  import(
      /* webpackChunkName: "ace-builds/development/others/[request]" */
      /* webpackMode: "lazy" */
      `ace-builds/src-noconflict/${otherFiles}`).catch((e) => null);
}
